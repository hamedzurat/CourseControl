/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 714d5278774ee1d61bd3884b68e77e80)
// Runtime types generated with workerd@1.20260114.0 2026-01-14 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/index');
    durableNamespaces: 'StudentDO' | 'SectionDO' | 'SubjectDO' | 'EverythingDO' | 'AdminDO' | 'FacultyDO';
  }
  interface Env {
    ...
    JWT_ISSUER: string;
    JWT_AUDIENCE: string;
    STUDENT_DO: DurableObjectNamespace<import('./src/index').StudentDO>;
    SECTION_DO: DurableObjectNamespace<import('./src/index').SectionDO>;
    SUBJECT_DO: DurableObjectNamespace<import('./src/index').SubjectDO>;
    EVERYTHING_DO: DurableObjectNamespace<import('./src/index').EverythingDO>;
    ADMIN_DO: DurableObjectNamespace<import('./src/index').AdminDO>;
    FACULTY_DO: DurableObjectNamespace<import('./src/index').FacultyDO>;
    R2_STATE: R2Bucket;
    DB: D1Database;
  }
}
